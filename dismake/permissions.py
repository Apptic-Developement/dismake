...
class Permissions(IntFlag):
    ...
    SEND_MESSAGES = 1 << 11  # Allows for sending messages in a channel and creating threads in a forum (does not allow sending messages in threads) (T, V, S)
    ...
    EMBED_LINKS = 1 << 14  # Links sent by users with this permission will be auto-embedded (T, V, S)
    ...
    USE_EXTERNAL_EMOJIS = 1 << 18  # Allows the usage of custom emojis from other servers (T, V, S)
